...
-(void)setUpChart:(NSArray *)weatherarry{
    
    NSLog(@"setUpChartvsetUpChartsetUpChart");
	if (self.chartStyle == SCChartLineStyle) {
		...
		[_lineChart strokeChart:(NSArray *)weatherarry];
...
- (void)showInView:(UIView *)view:(NSArray *)weatherarry
{
    [self setUpChart:weatherarry];
